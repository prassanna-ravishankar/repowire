...
<!-- BOOTSTRAP.md ritual populates this on first run by probing local git roots
     (~/git, ~/development/projects, ~/code, ~/projects, ~/work) and gh api user/repos.
     Until then, this is empty. -->

_(no projects yet; populated by BOOTSTRAP ritual or manually)_
