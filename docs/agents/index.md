...
`repowire setup` auto-detects every installed agent runtime and wires hooks + MCP for each. These pages are for when the auto-detection breaks, or when you want to know what was wired and why.
